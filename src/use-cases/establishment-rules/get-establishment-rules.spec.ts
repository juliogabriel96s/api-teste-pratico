...
import { GetEstablishmentRuleUseCase } from "./get-establishment-rules"
...
let sut: GetEstablishmentRuleUseCase

describe('Get Establishment rule', () =>{
beforeEach(() =>{
    ...
    sut = new GetEstablishmentRuleUseCase(inMemoryEstablishmentRuleRepository)
})

it('Should be able get a establishment rule', async() =>{
...
it('Should not be able to get  a establishment rule with id wrong', async() =>{
